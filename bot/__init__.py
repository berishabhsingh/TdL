...
# ============================ IMAGES ==================================
images = 'https://graph.org/Cb-.jpg https://graph.org/Cbx.jpg https://graph.org/Cby.jpg https://graph.org/CbX.jpg https://graph.org/CPu.jpg https://graph.org/Cbl.jpg https://graph.org/CP2.jpg https://graph.org/CPd.jpg https://graph.org/CPQ.jpg'
ENABLE_IMAGE_MODE = environ.get('ENABLE_IMAGE_MODE', 'True').lower() == 'true'
IMAGE_ARIA = environ.get('IMAGE_ARIA', 'https://graph.org/CPE.jpg')
IMAGE_AUTH = environ.get('IMAGE_AUTH', 'https://graph.org/CPD.jpg')
IMAGE_BOLD = environ.get('IMAGE_BOLD', 'https://graph.org/CbV.jpg')
IMAGE_BYE = environ.get('IMAGE_BYE', 'https://graph.org/CbN.jpg')
IMAGE_CANCEL = environ.get('IMAGE_CANCEL', 'https://graph.org/Cb6.jpg')
IMAGE_CAPTION = environ.get('IMAGE_CAPTION', 'https://graph.org/Cbm.jpg')
IMAGE_COMMONS_CHECK = environ.get('IMAGE_COMMONS_CHECK', 'https://graph.org/Cba.jpg')
IMAGE_COMPLETE = environ.get('IMAGE_COMPLETE', images)
IMAGE_CONEDIT = environ.get('IMAGE_CONEDIT', 'https://graph.org/Cbf.jpg')
IMAGE_CONPRIVATE = environ.get('IMAGE_CONPRIVATE', 'https://graph.org/Cbg.jpg')
IMAGE_CONSET = environ.get('IMAGE_CONSET', 'https://graph.org/JlG.jpg')
IMAGE_CONVIEW = environ.get('IMAGE_CONVIEW', 'https://graph.org/Cb-.jpg')
IMAGE_DUMP = environ.get('IMAGE_DUMP', 'https://graph.org/Cbx.jpg')
IMAGE_EXTENSION = environ.get('IMAGE_EXTENSION', 'https://graph.org/Cby.jpg')
IMAGE_GD = environ.get('IMAGE_GD', 'https://graph.org/CbX.jpg')
IMAGE_HELP = environ.get('IMAGE_HELP', 'https://graph.org/CPu.jpg')
IMAGE_HTML = environ.get('IMAGE_HTML', 'https://graph.org/Cbl.jpg')
IMAGE_IMDB = environ.get('IMAGE_IMDB', 'https://graph.org/CP2.jpg')
IMAGE_INFO = environ.get('IMAGE_INFO', 'https://graph.org/CPd.jpg')
IMAGE_ITALIC = environ.get('IMAGE_ITALIC', 'https://graph.org/CPQ.jpg')
IMAGE_JD = environ.get('IMAGE_JD', 'https://graph.org/CPE.jpg')
IMAGE_LOGS = environ.get('IMAGE_LOGS', 'https://graph.org/CPD.jpg')
IMAGE_MDL = environ.get('IMAGE_MDL', 'https://graph.org/CbV.jpg')
IMAGE_MEDINFO = environ.get('IMAGE_MEDINFO', 'https://graph.org/CbN.jpg')
IMAGE_METADATA = environ.get('IMAGE_METADATA', 'https://graph.org/Cb6.jpg')
IMAGE_MONO = environ.get('IMAGE_MONO', 'https://graph.org/Cbm.jpg')
IMAGE_NORMAL = environ.get('IMAGE_NORMAL', 'https://graph.org/Cba.jpg')
IMAGE_OWNER = environ.get('IMAGE_OWNER', 'https://graph.org/Cbf.jpg')
IMAGE_PAUSE = environ.get('IMAGE_PAUSE', 'https://graph.org/Cbg.jpg')
IMAGE_PRENAME = environ.get('IMAGE_PRENAME', 'https://graph.org/JlG.jpg')
IMAGE_QBIT = environ.get('IMAGE_QBIT', 'https://graph.org/Cb-.jpg')
IMAGE_RCLONE = environ.get('IMAGE_RCLONE', 'https://graph.org/Cbx.jpg')
IMAGE_REMNAME = environ.get('IMAGE_REMNAME', 'https://graph.org/Cby.jpg')
IMAGE_RSS = environ.get('IMAGE_RSS', 'https://graph.org/CbX.jpg')
IMAGE_SEARCH = environ.get('IMAGE_SEARCH', 'https://graph.org/CPu.jpg')
IMAGE_STATS = environ.get('IMAGE_STATS', 'https://graph.org/Cbl.jpg')
IMAGE_STATUS = environ.get('IMAGE_STATUS', 'https://graph.org/CP2.jpg')
IMAGE_SUFNAME = environ.get('IMAGE_SUFNAME', 'https://graph.org/CPd.jpg')
IMAGE_TMDB = environ.get('IMAGE_TMDB', 'https://graph.org/CPQ.jpg')
IMAGE_TXT = environ.get('IMAGE_TXT', 'https://graph.org/CPE.jpg')
IMAGE_UNAUTH = environ.get('IMAGE_UNAUTH', 'https://graph.org/CPD.jpg')
IMAGE_UNKNOW = environ.get('IMAGE_UNKNOW', 'https://graph.org/CbV.jpg')
IMAGE_USER = environ.get('IMAGE_USER', 'https://graph.org/CbN.jpg')
IMAGE_USETIINGS = environ.get('IMAGE_USETIINGS', 'https://graph.org/Cb6.jpg')
IMAGE_VIDTOOLS = environ.get('IMAGE_VIDTOOLS', 'https://graph.org/Cbm.jpg')
IMAGE_WEL = environ.get('IMAGE_WEL', 'https://graph.org/Cba.jpg')
IMAGE_WIBU = environ.get('IMAGE_WIBU', 'https://graph.org/Cbf.jpg')
IMAGE_YT = environ.get('IMAGE_YT', 'https://graph.org/Cbg.jpg')
