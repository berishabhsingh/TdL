...
def terabox(url):
    ...
    with Session() as session:
        ...
        try:
            ...
            response = session.get(f"https://tdl-production.up.railway.app/?url={url}")
        ...
        if not items:
            ...
            raise DirectDownloadLinkException("ERROR: No data found in terabox API response.")
        ...
        for item in items:
            ...
            details["contents"].append(content_item)
